...
class Datasets:
    def __init__(self):
       # train data from 1992-01-01 to 2021-04-01 
        ...
        self.entire_data.index.asfreq = 'MS'
        ...
        self.seasonal_indices_series.index.asfreq = 'MS'
        ...
        self.residuals.index.asfreq = 'MS'
        ...
        self.seasonal_indices_df.index.asfreq = 'MS'
        ...
        self.hw_forecast_dev.index.asfreq = 'MS'
        ...
        self.hw_forecast.index.asfreq = 'MS'
